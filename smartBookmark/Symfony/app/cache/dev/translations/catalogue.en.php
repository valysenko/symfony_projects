...
$catalogue = new MessageCatalogue('en', array (
  ...
  array (
    'Вхід' => 'Enter',
    'Невірний логін/пароль' => 'Invalid login/password',
    'Реєстрація' => 'Registration',
    'Додати' => 'Add',
    'Надіслані' => 'Responsed',
    'Популярні' => 'Popular',
    'Мої закладки' => 'My bookmarks',
    'Назва' => 'Name',
    'Опис' => 'Description',
    'Категорія' => 'Category',
    'Додавання закладки' => 'Adding bookmark',
    'Надіслати' => 'Send',
    'Видалити' => 'Delete',
    'Перейти' => 'Go to',
    'Відправка закладки другу' => 'Sending a bookmark to friend',
    'Редагування користувача' => 'User edit',
    'Вийти' => 'Exit',
    'Редагувати' => 'Edit',
    ...
    'Відновлення пароля' => 'Restore password',
    'Вітаємо, Ваші нові дані для доступу в систему' => 'Hello, your new data for system access',
    'логін' => 'login',
    'пароль' => 'password',
    'Нова закладка' => 'New bookmark',
    'Вітаємо, Вам надіслали закладку! Зайдіть в систему, щоб подивитися' => 'Hello! Somebody send you a bookmark! Log in to the system to check:',
  ),
));
